...
var Draggable = { template: "<div class=\"vddl-draggable\" @dragstart.stop=\"handleDragstart\" @dragend.stop=\"handleDragend\" @click.stop=\"handleClick\" @selectstart=\"handleSelected\"><slot></slot></div>",
  ...
  computed: {},
  methods: {
    handleDragstart: function handleDragstart(event,data) {
      var this$1 = this;
...
//    alert(draggable)
      ...
      if (typeof(this.dragstart) === 'function') {
        this.dragstart.call(this, event.target,draggable);
      }
    },

    handleDragend: function handleDragend(event,el,data) {
      var this$1 = this;
      ...
      if (typeof(this.dragend) === 'function') {
        this.dragend(dropEffect, event.target,this$1.draggable);
      }
