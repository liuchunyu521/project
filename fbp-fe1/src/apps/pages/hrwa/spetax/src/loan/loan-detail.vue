...
<template>
    <ifbp-page>
        <ifbp-breadcrumb name="住房贷款" v-show="false"></ifbp-breadcrumb>
        ...
        <ifbp-panel  v-if="isinitiateFlowShow">
                <initiateFlow ref="initfolwRef" class="fl" :billId="pk_loan_h" billType="TAX1"
            ...
            <!-- 子表编辑页签 :pkTemp="subTemplate"
                ...
                <ifbp-panel id="subPanel" title="住房贷款详情"  class="titleLine" :icons="addicons" >
