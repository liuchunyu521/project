<template>
    <ifbp-page>
        <!--节点title-->
        <ifbp-breadcrumb name="公共薪资项目详情"></ifbp-breadcrumb>
        <!-- 按钮区域 -->
        <ifbp-footer>
            ...
            <el-button type="primary" @click="waItemEdit" v-if="!itemEdit">编辑</el-button>
        </ifbp-footer>
        <!-- 主体区域 -->
        ...
        <ifbp-main-area type="detail">
            <ifbp-panel-group :navbar="false">
                ...
                <ifbp-panel id="waItemPanel" title="基本信息">
                    <div style="border-top:1px solid #E6E6EB;margin:18px 0 24px 0px; "></div>
                ...
                <ifbp-panel id="dataSourcePanel" title="项目数据来源" :icons="[]">
                    ...
                    <el-form label-width="150px" :adaptation="true" :inline="true">
                        <el-form-item label="数据来源" :required="true" style="margin-right: 10px">
                            ...
                            <el-select v-model="dataSource" placeholder="请选择" id="dataSource"
                        ...
                        <el-form-item :required="true" v-if="dataSource==1">
                            <el-ref _id="dataSourceWageform" :editable="itemEdit"
                                    v-model="dataSourceTmeplate[1].formula"
                                    field="formula"
                        ...
                        <el-form-item :required="true" v-if="dataSource==4">
                            <el-ref _id="dataSourceWagrade" :editable="itemEdit" v-model="dataSourceTmeplate[4].formula"
                                    ...
                                    ref-code="wagrade" :disabled="dataSourceDisabled"
                                    style="width:250px;display:inline-block;">
                            </el-ref>
                        </el-form-item>
                    </el-form>
...
<script>
    ...
    export default {
        ...
        data() {
            ...
            params.waitem = {};
            params.waitem.pk_wa_class = params.pk_waitem;
            params.waitem.pk_org = params.pk_org;
            params.waitem.cyear = params.cyear;
            params.waitem.cperiod = params.cperiod;
            return {
                ...
                classitemFormResetFun: function ($node) {
                    ...
                    if ($category_id.length == 1) {
                        $category_id.children().first().attr(':disabled', 'waitem.category_id_disabled');
                    }

                    //数值类型
                    var $iitemtype = $node.find("[v-model='waitem.iitemtype']");
                    $iitemtype.attr('v-on:trigger', 'onTriggerItemtype');
                    $iitemtype.attr(':disabled', 'iitemtype_disabled');

                    //增减属性
                    var $iproperty = $node.find("[v-model='waitem.iproperty']");
                    //$iproperty.attr('v-on:trigger', 'onTriggerIproperty');
                    $iproperty.attr(':disabled', 'iproperty_disabled');
                    ...
                    if ($isinhi.length == 1) {
                        ...
                        //$isihi.children().first().attr(':disabled', 'waitem.isinhi_disabled');
                    }
                    //扣税
                    ...
                    //数据来源
                    var $dataSource = $node.find("[v-model='dataSource']");
                    $dataSource.attr(':disabled', 'dataSource_disabled');
        ...
        methods: {
            ...
            requestBaseBaseInfo() {
                ...
                this.itemEdit = this.$root.$router.currentRoute.params.nn == "true";
                ...
                this.$http({
                    ...
                    .then(res => {
                        if (res.data.status === true) {
                            ...
                            var itemtype = originalValue.iitemtype;
                            ...
                            if (itemtype == 2) {
                                ...
                                // 数据类型只读
                                this.$refs.ref_classitem_c.setData("dataSource_disabled", true);
...
//
            ...
            waItemEdit(){
                ...
                if (data.category_id == "1001Z7100000000WA001") {
                    this.$alert('系统项目不能修改', {
                            confirmButtonText: '确定',
                        }
                    )
                    ...
                    //设置数据来源控件绑定的数据
                    this.setItemDataSource(data.iitemtype);
                }
            }
        },
