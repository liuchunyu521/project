<template>
  <ifbp-page>
    <ifbp-breadcrumb name="个别调整卡片"></ifbp-breadcrumb>
    <!-- 主体区域 -->
  ...
  export default {
          ...
          formMethods:{
              ...
              afterSelectClassItem(type, data){
                  if (type === 'change') {
                      ...
                      this.$http({
                          url: "/hrwa/payData/queryDataById",
                          method: "post",
                          data:{
                              pk_org:pk_org,
                              pk_wa_class :pk_wa_class,
    ...
    methods: {
      ...
      requestBaseBaseInfo() {
        ...
        this.$http({
          url: "/hrwa/payData/payDatas/queryAdjustInfoById",
          method: "post",
      ...
      confirm() {
        ...
        this.$refs.ref_datas_c.validate(valid => {
          if (valid) {
            this.$http({
              url: "/hrwa/payData/payDatas/save",
              method: "post",
              data: {
              ...
              .then(res => {
                ...
                if (res.data.status === true) {
                    ...
                    this.$router.push({path : "/hrwa/paydata/adjustinfo",query:queryParam});
                } else {
                  this.$message({
                    message: res.data.msg,
                    type: "error"
