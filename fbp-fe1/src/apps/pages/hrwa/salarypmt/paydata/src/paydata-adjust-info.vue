...
<template>
  <ifbp-page>
    <!-- 节点title -->
    <ifbp-breadcrumb name="个别调整列表"></ifbp-breadcrumb>
    <!-- 按钮区域 -->
    <ifbp-button-area>
...
//        multiDelDialogVisible: false,
    ...
    methods: {
      ...
      request(n, s) {
        ...
        var url =
          "/hrwa/payData/payDatas/queryAdjustInfo";
        this.$http({
          url: url,
          method: "post",
          data: {
      ...
      tableEditClick(scope) {
          ...
          this.$router.push({path:"/hrwa/paydata/adjustdetail", query:queryParma}) ;
      },
      // table行的删除操作
...
//        this.delDialogVisible = true;
      ...
      add () {
          ...
          this.$router.push({path:"/hrwa/paydata/adjustadd",query:param});
      },
...
//        this.delDialogVisible = false;
        ...
        this.$http({
          url: "/hrwa/payData/payDatas/delete",
          method: "post",
          data:{
              pk_wa_class : this.pk_wa_class,
              pk_org : this.pk_org,
      ...
      multiDeleteClick() {
        ...
        this.$http({
          url: "/hrwa/payData/payDatas/multiDelete",
          method: "post",
          data:{
              pk_wa_class : this.pk_wa_class,
              pk_org : this.pk_org,
