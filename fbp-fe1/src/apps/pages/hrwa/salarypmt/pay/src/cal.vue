  ...
  <div>
      <ifbp-main-area type="list" class="maringTop0">
        ...
        <div class="ifbp-btn-line" v-if="btnisShow"> 
       	 	<div class="fl">
	            <span class="ifbp-layout-content-left-span">已计算：{{caculateCount}}/{{totalElements}} &nbsp;&nbsp;&nbsp;&nbsp;已审核：{{checkCount}}/{{totalElements}}</span>
          	</div>
          ...
          <ifbp-btn-line 
            ...
            style="margin-top:-16px;width: calc(100% - 240px);float: right;">
    ...
    <!-- 主体区域 -->
      ...
      <ifbp-template ref="ref_paydatacal"
                     tpl-id="paydatacal"
                     :tpl-data="tableData"
      ...
      <alertDataDlg ref="ref_alertdata" @changeWaState="changeWaState" :pk_org="pk_org" :pk_wa_class="pk_wa_class" :cyear="cyear"  :cperiod="cperiod" ></alertDataDlg>
...
export default {
    ...
    components: { batch_edit,paydataAdjustinfodlg ,ontimeDlgInfoDlg,alertDataDlg,"ifbp-btn-line":IfbpBtnLine},
    ...
    data() {
        ...
        return {
            ...
            otherHeight:230,
            options: [{
                value: 'caculateflag_Y',
                label: '已计算'
            }, {
                value: 'caculateflag_N',
                label: '未计算'
            }, {
                value: 'checkflag_Y',
                label: '已审核'
            ...
            tableResetFun: function ($node) {
                ...
                var colHTML = "";
                // colHTML = colHTML + '<el-table-column type="selection" align="right" width="55"></el-table-column>';
...
//          },
    ...
    methods: {
        ...
        resetTableHeight(height){
           this.$refs.ref_paydatacal.setData('tBodyHeight',height);
        },
        directExport(){
            ...
            return this.$http({
                ...
                .then(res => {
                    ...
                    if (res.data.status === true) {
                        ...
                        this.$refs.ref_paydatacal.setData('columns', this.columnsData);
                        this.$refs.ref_paydatacal.init();
        ...
        confirm() {
            var data = this.$refs.ref_paydatacal.getData("paydata");

            var psnData = this.$refs.ref_paydatacal.getData("paydata");
            ...
            this.$refs.ref_paydatacal.validate(valid => {
                if (valid) {
                    this.$http({
                        ...
                        .then(res => {
                            ...
                            if (res.data.status === true) {
                                ...
                                var currentDatas = this.$refs.ref_paydatacal.getTableData();
        ...
        edit() {
            var data = this.$refs.ref_paydatacal.getFormData();
        ...
        cancel() {
            ...
            if (this.isEdit) {
                ...
                this.$refs.ref_paydatacal.formShow = false;
                this.$refs.ref_paydatacal.getTableComp().closeExpandRow();
            }
        },
                ...
                .then((res) => {
                    if (res.data.status === true) {
                        this.$nextTick(() => {
                            ...
                            if (this.$refs.ref_paydatacal) {
                                this.tableListData = res.data.data.content;
                                this.$refs.ref_paydatacal.setTableData(
                                    this.tableListData
                                );
            ...
            this.$http({
                ...
                .then(res => {
                    ...
                    if (res.data.status === true) {
                        ...
                        this.$set(this.textBtnArr[0],"disabled",res.data.data.caculateDisabled);
                        ...
                        var detailCompareDisabled = res.data.data.detailCompareDisabled;
                        this.$set(this.textBtnArr[5],"disabled",detailCompareDisabled);
                        ...
                        var batchEditDisabled = this.textBtnArr[0].disabled && this.checkDisabled;
                        this.$set(this.textBtnArr[2],"disabled",batchEditDisabled);
                        
                        var adjustDisabled = this.textBtnArr[0].disabled && this.checkDisabled;
                        this.$set(this.textBtnArr[3],"disabled",adjustDisabled);
                        
                        var ontimeDisabled = this.textBtnArr[0].disabled && this.checkDisabled;
                        this.$set(this.textBtnArr[4],"disabled",ontimeDisabled);
                        //
                        var importDataDisabled = this.textBtnArr[0].disabled && this.checkDisabled;
//                      this.$set(this.textBtnArr[1],"disabled",importDataDisabled);
                        
                        var exportDataDisabled = this.textBtnArr[0].disabled && this.checkDisabled;
						this.$set(this.textBtnArr[1],"disabled",false);
						
                        this.$set(this.textBtnArr[6],"disabled",importDataDisabled);
                        
						this.$set(this.textBtnArr[7],"disabled",false);
                        ...
                        this.showCaculate = !this.textBtnArr[0].disabled;
        ...
        alertUncaculatePsn() {
            ...
            this.$confirm('本期间有员工的定调薪信息发生变化，请先核算时点发放金额，再进行薪资计算', '提示', {
                ...
                this.$router.push({ path: "/hrwa/paydata/paydataOntimeinfo", query: queryParam });
            }).catch(() => {
                // 这里加取消逻辑
            });
        },
        caculateAllData() {
            var selectedDatas = this.$refs.ref_paydatacal.getTableData();
            this.$http({
                ...
                .then(res => {
                    ...
                    if (res.data.status === true) {
                        ...
                        if(res.data.data.needAlert === true){
        ...
        getOperateDatas() {
            var tableSelections = this.$refs.ref_paydatacal.comp.$refs.ref_paydatacal.getSelection();
            var selectedDatas = [];
            ...
            if (selectedDatas.length == 0) {
                selectedDatas = this.$refs.ref_paydatacal.getTableData();
            }
        ...
        showHeaderSetting() {//设置显示列
            this.$refs.ref_paydatacal.setTransferVisible(true);
        }
    }
};
</script>
