    ...
    methods: {
		checkchange(){
        		if(this.checkedall==true){
        			this.$refs.ref_alter_partout.getTableComp().selectAllRow();
        			this.$emit('setIsAllPageSelect', true);
        		}else if(this.checkedall==false){
        			this.$refs.ref_alter_partout.getTableComp().unSelectAllRow();
        ...
        this.$http({
          ...
          .then(res => {
            if (res.data.status === true) {
              ...
              this.initPromise(this.$refs.ref_alter_partout.setData(
                "hi_psnjob_t",
