    ...
    <ifbp-page>
        ...
        <ifbp-main-area type="detail">
            <ifbp-panel-group :navbar="false">
                ...
                <!-- 子表页签 -->
                <ifbp-panel id="subPanel" title="定调薪信息" :icons="wadocEdit?null:addicons" :toggle-show="false">
                    <ifbp-template ref="ref_psndocwadoc_sub"
                                   ...
                                   :confirm-button-show="wadocEdit"
                                   :edit-button-show="!wadocEdit"
                                   :cancel-button-show="wadocEdit"
                                   :delete-button-show="!wadocEdit"
                                   confirm-button="保存"
                                   edit-button="编辑"
                                   cancel-button="取消"
                                   delete-button="删除"
...
<script>
    ...
    import gradePrmSecDialog from './gradeprmsec-dialog.vue';
                ...
                wadocFormMethods: {
                    handleChange(val){
                        if(val.returnValue){
                            ...
                            data.pk_wa_grd = null;
                            data.nmoney = null;
                            data.criterionvalue = null;
                            data.crt_min_value = null;
                            data.crt_max_value = null;
                            data.pk_wa_crt = null;
                        }
                    },
                    wagrdChange(type,val){
                        ...
                        vm.$refs.ref_psndocwadoc_sub.getFormData().criterionvalue =null;
                        vm.$refs.ref_psndocwadoc_sub.getFormData().crt_min_value = null;
                        vm.$refs.ref_psndocwadoc_sub.getFormData().crt_max_value = null;
                    ...
                    wacrtChange(type,val){
                        ...
                        if(temp){
                            if(temp.criterionvalue){
                                ...
                                vm.$refs.ref_psndocwadoc_sub.getFormData().criterionvalue=temp.criterionvalue;
                                vm.$refs.ref_psndocwadoc_sub.getFormData().crt_min_value = temp.min_value;
                                vm.$refs.ref_psndocwadoc_sub.getFormData().crt_max_value = temp.max_value;
                            }else{
                                vm.$refs.ref_psndocwadoc_sub.getFormData().nmoney=null;
                                vm.$refs.ref_psndocwadoc_sub.getFormData().criterionvalue=null;
                                vm.$refs.ref_psndocwadoc_sub.getFormData().crt_min_value = null;
                        ...
                        if (res.data.status === true) {
                            this.$nextTick(() => {
                                ...
                                if(data){
                                    ...
                                    this.$refs.ref_psndocwadoc_sub.setTableData(JSON.parse(JSON.stringify(data)));
                                }else{
                                    this.$refs.ref_psndocwadoc_sub.tableShow = false;
                                ...
                                this.$refs.ref_psndocwadoc_sub.init();
