...
<template>
    <ifbp-page>
        <!--节点title-->
        <ifbp-breadcrumb name="团队休假" v-show="false"></ifbp-breadcrumb>
        <!-- 按钮区域 -->
...
export default {
    ...
    data() {
        ...
        return {
            ...
            deftype:[ ],
            // 功能编码
            funcode: 'funcode=60420leaveapply',
            // 权限前缀
            ...
            // 查询模板传入参数
            tplCode: 'hrss_leaveapply_l',
            optionCountBeforeMore: 4,
            searchTemplate: {},

            // UI模板传入参数
            tableRef: 'ref_leaveapplyh_l',
            tabletplData: {},
  ...
  /*  mounted() {
    ...
    methods: {
        showTableSetting() {
            this.$refs.ref_leaveapplyh_l.setTransferVisible(true);
        },
