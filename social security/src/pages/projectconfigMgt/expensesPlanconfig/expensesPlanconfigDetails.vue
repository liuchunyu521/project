                        ...
                        <div>
                            ...
                            <a-table ref="adjustGoldconfigwrap" style="margin-top:8px" align="'center'"  bordered :dataSource="dataSource" :columns="columns" :pagination="false" :scroll="{ x: 1600 }">
                                ...
                                <template slot="dataIntoWay" slot-scope="text, record">
                                    ...
                                    <a-select   v-model="record.dataIntoWay"  class="inputstyle" @change="onCellChange(record, 'dataIntoWay',record.dataIntoWay)">
                                ...
                                <template slot="dockingSys" slot-scope="text, record">
                                    ...
                                    <div class="rowIdbc01" v-if="record.dataIntoWay =='01'"></div>
                                    <div class="rowIdbc01" v-else-if="record.dataIntoWay =='03'"></div>
...
export default {
  ...
  methods: {
    ...
    handleSubmit (e,_data) {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
            ...
            subdata.formData.businessType="YKJH";
    ...
    testhandleOk() {//测试弹框确定
        ...
        console.log(_Data)
        var _url=this.service_sms+'/api/fundUsage/connectivityTest';
