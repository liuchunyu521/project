...
//			{ "id": "sex", "text": "性别", "disabled": true, },
			...
			{ "id": "email", "text": "集团邮箱:", "disabled": true },
    		{ "id": "glbdef2", "text": "单位邮箱:", "disabled": true },
			{ "id": "officephone", "text": "电话:" },
    	...
    	baseInfo2: [{ "id": "nationality", "text": "民族:", "type": "refer", "typedata": [{"code": "HR002_0xx"}], /*"valid": [{ required: true, message: '不能为空', trigger: 'change' }]*/},
			...
			{ "id": "bloodtype", "text": "血型:", "type": "refer", "typedata": [{"code": "bloodtype"}] },
			 { "id": "nativeplace", "text": "籍贯:","type": "region", "typedata": [{"prevkey": "pk_country","valkey": "addrnativeplace","sign":"1"}]},
			 { "id": "permanreside", "text": "户口所在地:","type": "region", "typedata": [{"prevkey": "pk_country","valkey": "addrpermanreside","sign":"2"}]},
			{ "id": "characterrpr", "text": "户口性质:", "type": "refer", "typedata": [{"code": "HR005_0xx"}], /*"valid": [{ required: true, message: '不能为空', trigger: 'change' }]*/ },
            // { "id": "fileaddress", "text": "档案所在地:", "type": "refer", "typedata": [{ "code": "HRSD04" }] },
			{ "id": "glbdef19", "text": "档案所在地:", "type": "refer", "typedata": [{ "code": "HRSD04" }] },
			{ "id": "censusaddr", "text": "户籍地址:"},
			{ "id": "addr_show", "text": "家庭住址:", "type": "region", "typedata": [{ "prevkey": "pk_country", "valkey": "addr","sign":"3" }] },
			{ "id": "marriagedate", "text": "结/离婚日期:", "type": "date" },
      		{ "id": "glbdef14", "text": "出生地:","type": "region", "typedata": [{"prevkey": "pk_country","valkey": "addrglbdef14","sign":"4"}]},
    		
            // { "id": "glbdef3", "text": "个人邮箱:", "valid": [{ validator: validForm.email, trigger: 'change' }] },
            // { "id": "glbdef3", "text": "AD域账号:", "valid": [{ validator: validForm.email, trigger: 'change' }] },
    		{ "id": "glbdef3", "text": "AD域账号:", "disabled": true },
            ...
            { "id": "glbdef45", "text": "进入华融时间:", "disabled": false ,"type":"date" },
    		{ "id": "glbdef6", "text": "进入金融行业时间:", "disabled": false,"type": "date" },
    		{ "id": "glbdef9", "text": "进入经济等相关行业时间:", "disabled": false,"type": "date" },
    		{ "id": "glbdef15", "text": "出生日期（档案）:", "disabled": false ,"type": "date"},
